...
function updateMin(slideAmount) {
    var ks = slideAmount/1000;
    
    console.log(ks.length);
    
    //get the element
    var display = document.getElementById("min_value");
    //show the amount
    display.innerHTML='$'+ks+'K';
}

function updateMax(slideAmount) {
    var ks = slideAmount/1000;
    
    //get the element
    var display = document.getElementById("max_value");
    //show the amount
    display.innerHTML='$'+ks+'K';
}
...
$(document).ready(function() {
    ...
    //Setup sliders for editing min/max search params
    var min_template ='<div id="slider" class="price_slider min"> <span id="slider_min">$50K</span> <input id="min_range" type="range" min="50000" max="3000000" step="50000" value="500000" onchange="updateMin(this.value);" /><span id="slider_max" class="pull-right">$3M</div>';
    
    $('#min_value').popover({
        container: 'body'
        ,content: min_template
        ,trigger: 'click'
        ,html :true
        ,placement: 'bottom'
        ,title: 'Minimum Price'
    ...
    var max_template ='<div id="slider" class="price_slider max"> <span id="slider_min">$50K</span> <input id="min_range" type="range" min="50000" max="3000000" step="50000" value="500000" onchange="updateMax(this.value);" /><span id="slider_max" class="pull-right">$3M</div>';
    
    $('#max_value').popover({
        container: 'body'
        ,content: max_template
        ,html :true
        ,placement: 'bottom'
        ,title: 'Maximum Price'
    });
